...
public class AccountInfoService {
     ...
     *
     *注解@Inject同样可以实现自动注入功能，但是它跟@Autowired的区别：
     * 1.@Inject需要额外导入jar包。compile group: 'javax.inject', name: 'javax.inject', version: '1'
     * 2.@Inject是Java规范，@Autowired是Spring规范。
     * 3.@Inject是根据属性名称来注入的，不受@Primary影响。
     * 4.@Inject没有required属性。
     *
     * 强烈推荐使用 @Autowired 自动注入！！！
     */
    @Inject
